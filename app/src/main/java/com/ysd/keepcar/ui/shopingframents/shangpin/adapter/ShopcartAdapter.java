package com.ysd.keepcar.ui.shopingframents.shangpin.adapter;
...
import com.ysd.keepcar.ui.shopingframents.shangpin.entity.GoodsInfo;
import com.ysd.keepcar.ui.shopingframents.shangpin.entity.StoreInfo;
...
//            });
    ...
    static class GroupViewHolder {
       TextView tvSourceName;
        ...
        GroupViewHolder(View view) {
            determineChekbox =(CheckBox)  view.findViewById(R.id.determine_chekbox);
            tvSourceName =  (TextView)  view.findViewById(R.id.tv_source_name);
            tvStoreEdtor =  (Button)  view.findViewById(R.id.tv_store_edtor);
        }
    }
    ...
    static class ChildViewHolder {
        ...
        ChildViewHolder(View view) {
            ...
            ivAdapterListPic   =(ImageView) view.findViewById(R.id.iv_adapter_list_pic);
            tvIntro   =(TextView) view.findViewById(R.id.tv_intro);
            tvColorSize  =(TextView) view.findViewById(R.id.tv_color_size);
            tvPrice = (TextView)  view.findViewById(R.id.tv_price);

            tvDiscountPrice    =(TextView) view.findViewById(R.id.tv_discount_price);
            tvBuyNum   =(TextView) view.findViewById(R.id.tv_buy_num);
            rlNoEdtor   =(RelativeLayout) view.findViewById(R.id.rl_no_edtor);
            btReduce  =(Button) view.findViewById(R.id.bt_reduce);
            etNum = (EditText)  view.findViewById(R.id.et_num);

            btAdd    =(Button) view.findViewById(R.id.bt_add);
            llChangeNum   =(RelativeLayout) view.findViewById(R.id.ll_change_num);
            tvColorsize   =(TextView) view.findViewById(R.id.tv_colorsize);
            tvGoodsDelete  =(TextView) view.findViewById(R.id.tv_goods_delete);
            llEdtor = (LinearLayout)  view.findViewById(R.id.ll_edtor);
            stub = (ViewStub)  view.findViewById(R.id.stub);
        }
