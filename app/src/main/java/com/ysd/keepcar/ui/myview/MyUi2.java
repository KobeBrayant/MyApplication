package com.ysd.keepcar.ui.myview;
...
/**
 * Created by 特雷西麦克格蕾蒂 on 2017/12/27.
 */
...
public class MyUi2 extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int i = 0; i < viewWidth; i++) {
            canvas.drawLine(i, viewHeight, i, viewHeight-500-oneWave[i], mPaint);
            canvas.drawLine(i, viewHeight/2, i, viewHeight-500-twoWave[i]/2, mPaint);
        }
    ...
    public int dpChangPx(int dp) {
        ...
        return (int) (metrics.density * dp + 0.7f);
    }
